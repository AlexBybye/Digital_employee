...
| --- | --- | --- | --- | --- | --- |
| 那解冻之后多久能用 | 那解冻之后多久能用 | #1 | 100004 | 2 | ❌ |
| 如果是账号被冻结导致的呢 | 如果是账号被冻结导致的呢 | #1 | 1 | 1 | ✅ |
| 这个流程会记录日志吗 | 这个流程会记录日志吗 | #2 | 100003 | - | ❌ |
| 清理完还是高怎么办 | 清理完还是高怎么办 | #5 | 5 | 1 | ✅ |
| 能用RPA自动做吗 | 能用RPA自动做吗 | #3 | 100003 | - | ❌ |
| 处理完的结果会进知识库吗 | 处理完的结果会进知识库吗 | #4 | 5 | - | ❌ |
| 它有有效期限制吗 | 它有有效期限制吗 | account_lifecycle/密码策略 | 100002 | 1 | ✅ |
| 离职的还能恢复吗 | 离职的还能恢复吗 | account_lifecycle/账号解冻 | 100005 | 1 | ✅ |
| 那CPU高的呢 | 那CPU高的呢 | server_alert_handling/CPU 负载告警 | 100010 | 1 | ✅ |
| 这些告警是怎么分级的 | 这些告警是怎么分级的 | server_alert_handling/告警分级 | 100008 | 1 | ✅ |
| 创建完密码有什么要求 | 创建完密码有什么要求 | account_lifecycle/密码策略 | 100001 | - | ❌ |
